...
/*! \class Arete
* \brief classe représentant l'arete
*
* La classe gère le stockage et les traitements de l'arete
*/
class Arete
{
    public:
        ...
        * Méthode qui permet d'obtenir le poids1 de l'arete
        ...
        * Méthode qui permet d'obtenir le poids2 de l'arete
